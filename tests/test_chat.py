...
class TestDementiaSimulationRules(unittest.TestCase):
    ...
    def test_apply_mood_rules_stress_keywords(self):
        ...
        stressful_context = ["The doctor said you need medicine", "You're wrong about that"]
    ...
    def test_apply_mood_rules_calming_keywords(self):
        ...
        calming_context = ["Your family loves you", "Let's remember the good times at home"]
...
class TestIntegration(unittest.TestCase):
    ...
    def test_memory_forgetting_pattern(self):
        ...
        self.assertLess(len(state["short_term_memory"]), 15)  # Not everything in short-term
